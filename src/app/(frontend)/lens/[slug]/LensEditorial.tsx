      ...
      <div>
        ...
        {licensingText && (
          <div className="grid gap-4 border border-site-border-subtle bg-site-surface-elevated/65 p-5 sm:p-6 lg:grid-cols-[minmax(12rem,0.7fr)_minmax(0,2fr)] lg:gap-12">
            <h2 className="font-mono text-[0.625rem] font-semibold tracking-[0.12em] text-site-accent uppercase">
              Licensing
            </h2>
            <p className="max-w-3xl text-sm leading-relaxed text-site-text-secondary">
              {licensingText}
            </p>
          </div>
        )}
