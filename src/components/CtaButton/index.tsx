...
const CTA_APPEARANCE = {
  radius: 18,
  tint: 'var(--site-surface-elevated)',
  tintOpacity: 0.78,
  hoverTint: 'var(--site-accent)',
  hoverTintOpacity: 0.12,
  borderColor: 'var(--site-border-subtle)',
  blur: 0,
  textColor: 'var(--site-text-primary)',
  focusColor: 'var(--site-accent)',
  lineColor: 'var(--site-accent)',
  baseColor: 'var(--site-border-control)',
  intensity: 1,
  shineSize: 10,
  shineFade: 40,
  thickness: 1,
