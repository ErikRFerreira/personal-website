...
type SharedSpecularButtonProps = {
  children?: ReactNode
  size?: ButtonSize
  radius?: number
  tint?: string
...
export type SpecularButtonProps = SpecularButtonAsButtonProps | SpecularButtonAsLinkProps
...
const SpecularButton = ({
  ...
  const sharedProps = {
    ...
    style: {
      ...
      '--sb-hover-tint': hoverTint,
      '--sb-hover-tint-opacity': hoverTintOpacity,
      '--sb-border-color': borderColor,
      '--sb-focus-color': focusColor,
      '--sb-blur': `${blur}px`,
