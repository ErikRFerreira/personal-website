  ...
  return (
    ...
    >
      ...
      <div className="site-container relative z-10 flex min-h-[80svh] items-center py-20 md:py-28 lg:py-36">
        <div className="grid w-full grid-cols-1 items-center gap-14 md:grid-cols-12 md:gap-8 lg:gap-12">
          <div className="relative z-20 md:col-span-8 md:col-start-1 md:row-start-1">
            <h1
              aria-label={name}
